...
const WISH_MESSAGES = [
	"Happy 21 to my prettiest girl",
	"May Allah bless you always",
	"Hope you can achieve whatever you want in your life",
	"May every moment filled with joy and happiness",
	"Enjoy your special day Sayang",
	"I am so lucky to have you in my life",
	"I'm grateful for you every single second",
...
function startIntro() {
	...
	setTimeout(() => {
		...
		setTimeout(() => {
			...
			// CUSTOM1
			setTimeout(() => {
				showIntroText('HAPPY BIRTHDAY SAYANGG ❤️', false);
